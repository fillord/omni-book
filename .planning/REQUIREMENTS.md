...
- [ ] **CRM-01**: Tenant owner's booking history is aggregated into a `Client` Prisma model per unique phone/email, synced from existing bookings via a seeding action
