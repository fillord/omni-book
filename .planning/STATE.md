...
| 260409-edv | Security, performance, and architecture deep-dive audit — 22 findings across 4 domains, priority matrix + action plan | 2026-04-09 | 80da825 | [260409-edv-vulnerability-and-optimization-deep-dive](./quick/260409-edv-vulnerability-and-optimization-deep-dive/) |
...
| 260409-fbb | Security hotfix: CSPRNG OTP generation, remove SUPERADMIN email bypass, Telegram webhook secret validation, OTP rate limiting | 2026-04-09 | dc844ac | [260409-fbb-security-hotfix-crypto-otp-remove-auth-b](./quick/260409-fbb-security-hotfix-crypto-otp-remove-auth-b/) |
| 260409-hij | Replace in-memory rate limiter with Upstash Redis REST-backed fixed-window limiter shared across all serverless instances | 2026-04-09 | 065d6b5 | [260409-hij-replace-in-memory-rate-limiter-with-upst](./quick/260409-hij-replace-in-memory-rate-limiter-with-upst/) |
