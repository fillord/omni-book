...
- [x] **Phase 1: Landing / Marketing Surface** - Remediate all 7+ components in `components/landing/` (completed 2026-03-17)
- [x] **Phase 2: Tenant Public Booking Surface** - Remediate tenant-public-page, booking-form, booking-calendar (completed 2026-03-18)
...
- [x] 01-03-PLAN.md — Fix Footer.tsx build-blocking JSX syntax error (gap closure)
- [x] 01-04-PLAN.md — Replace dark:bg-zinc-900 with dark:bg-card + add test coverage (gap closure)
...
Plans:
- [x] 02-01-PLAN.md — Create test scaffold for BOOK-01 through BOOK-05
- [x] 02-02-PLAN.md — Remediate tenant-public-page.tsx (BOOK-01, BOOK-04, BOOK-05)
- [x] 02-03-PLAN.md — Remediate booking-form.tsx and booking-calendar.tsx (BOOK-02, BOOK-03, BOOK-04)
...
**Plans:** 4/4 plans complete
Plans:
- [x] 03-01-PLAN.md — Create test scaffold covering DASH-01 through AUTH-03 (Wave 1)
- [x] 03-02-PLAN.md — Remediate dashboard-sidebar.tsx and billing-content.tsx (DASH-01, DASH-02, DASH-05)
- [x] 03-03-PLAN.md — Remediate analytics-dashboard.tsx and confirm manager components (DASH-03, DASH-04)
- [x] 03-04-PLAN.md — Audit and confirm auth pages + visual checkpoint (AUTH-01, AUTH-02, AUTH-03)
...
| 1. Landing / Marketing Surface | 4/4 | Complete   | 2026-03-17 |
| 2. Tenant Public Booking Surface | 3/3 | Complete   | 2026-03-18 |
