...
- Usage: Reference from command with `@/home/yola/projects/sites/omni-book/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/yola/projects/sites/omni-book/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/yola/projects/sites/omni-book/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
