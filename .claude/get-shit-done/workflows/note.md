...
- **Global scope**: `/home/yola/projects/sites/omni-book/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/yola/projects/sites/omni-book/.claude/notes/`)
...
2. Glob `/home/yola/projects/sites/omni-book/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/yola/projects/sites/omni-book/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/yola/projects/sites/omni-book/.claude/notes/` — works in any directory
