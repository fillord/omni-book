...
export interface NicheConfig {
  ...
  /** Resource type values that represent people (staff/specialists).
   *  All other types are considered physical resources (rooms/equipment). */
  staffTypes: string[]
...
export const NICHE_CONFIG: Record<Niche, NicheConfig> = {
  medicine: {
    ...
    staffTypes: ['doctor', 'nurse'],
    resourceLabel:       'opt_66feeb',
    resourceLabelPlural: 'opt_4d744c',
    serviceLabel:        'opt_4e1cdb',
    bookingLabel:        'opt_d862ba',
    attributeFields: [
      { key: 'specialization',  label: 'attr_specialization', type: 'text',      required: true, forTypes: ['doctor', 'nurse'],                                              showInTable: true },
      { key: 'license',         label: 'opt_d7a770',          type: 'text',                      forTypes: ['doctor', 'nurse'],                                              showInTable: true },
      { key: 'experience_years',label: 'opt_c2283c',          type: 'number',                    forTypes: ['doctor', 'nurse'],                                              showInTable: true },
      { key: 'languages',       label: 'opt_cfc45c',          type: 'multitext',                 forTypes: ['doctor', 'nurse'] },
      { key: 'equipment',       label: 'opt_a135d0',          type: 'multitext',                 forTypes: ['operating_room', 'laboratory', 'office', 'treatment_room'],    showInTable: true },
    ],
  ...
  beauty: {
    ...
    resourceTypes: [
      { value: 'master',         label: 'resource_type_master' },
    ...
    attributeFields: [
      { key: 'specialization',   label: 'attr_specialization', type: 'text',      forTypes: ['master'], showInTable: true },
      { key: 'experience_years', label: 'opt_0cdcdc',          type: 'number',    forTypes: ['master'], showInTable: true },
      { key: 'skills',           label: 'opt_e8d0f9',          type: 'multitext', forTypes: ['master'] },
    ],
  ...
  horeca: {
    ...
    resourceTypes: [
      { value: 'staff',        label: 'resource_type_staff' },
  ...
  sports: {
    ...
    resourceTypes: [
      { value: 'trainer',   label: 'resource_type_trainer' },
    ...
    attributeFields: [
      { key: 'specialization',     label: 'attr_specialization', type: 'text',    forTypes: ['trainer'],                         showInTable: true },
      {
